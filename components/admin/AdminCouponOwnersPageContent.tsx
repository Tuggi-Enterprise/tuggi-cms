...
/**
 * Client-side content of the /admin/coupons/owners dashboard. See
 * AdminClientsPageContent for the rationale of living here instead of
 * directly under app/.
 */
...
export function AdminCouponOwnersPageContent() {
  return (
    <Suspense
      fallback={
        <div className="flex items-center justify-center min-h-screen">
