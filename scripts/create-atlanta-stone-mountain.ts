/**
 * create-atlanta-stone-mountain.ts
 *
 * Cria a rota "Stone Mountain & Parques de Atlanta — Natureza e Família" no banco de dados.
 *
 * O script:
 *   1. Define 14 landmarks do Stone Mountain Park e parques ao redor de Atlanta
 ...
 *      (POIs de Atlanta NÃO estão no banco Tuggi — todos serão genéricos)
 ...
 *
 * Uso:
 *   npx tsx scripts/create-atlanta-stone-mountain.ts
 *   npx tsx scripts/create-atlanta-stone-mountain.ts --force   # recria se já existir
 */
...
const ROUTE_NAME        = 'Stone Mountain & Parques de Atlanta — Natureza e Família'
const ROUTE_DESCRIPTION = 'O roteiro perfeito para famílias em Atlanta: explore tudo que o Stone Mountain Park oferece — a maior escultura de granito do mundo, a subida de teleférico com vistas espetaculares, o lago, a vila histórica e a trilha do século 19. Depois, descubra outros tesouros naturais dos arredores: a Arabia Mountain com suas rochas cor-de-rosa, o zoológico de Atlanta e os parques que fazem desta cidade uma das mais verdes do Sul americano. Um dia inteiro de carro pela natureza ao redor de Atlanta.'
const ROUTE_COUNTRY     = 'United States'
const ROUTE_REGION      = 'Atlanta'
...
const ROUTE_LANDMARKS: RouteLandmark[] = [
  // ── Stone Mountain Park (dentro e arredores) ──
  { name: 'Stone Mountain Park — Entrada Principal',                lat: 33.8082, lng: -84.1423 },
  { name: 'Confederate Memorial Carving Viewing Area',             lat: 33.8073, lng: -84.1367 },
  { name: 'Skylift Park — Teleférico até o Cume',                  lat: 33.8072, lng: -84.1387 },
  { name: 'Summit at Stone Mountain — Vistas de Atlanta',          lat: 33.8076, lng: -84.1404 },
  { name: 'Stone Mountain Lake & Beach',                           lat: 33.8062, lng: -84.1445 },
  { name: 'Crossroads — Vila Histórica do Século XIX',             lat: 33.8105, lng: -84.1410 },
  { name: 'Stone Mountain Village',                                lat: 33.8030, lng: -84.1699 },
  // ── Parques e natureza ao redor de Atlanta ──
  { name: 'Arabia Mountain National Heritage Area',                lat: 33.6965, lng: -84.1145 },
  { name: 'Panola Mountain State Park',                            lat: 33.6409, lng: -84.1583 },
  { name: 'Yellow River Wildlife Sanctuary',                       lat: 33.8648, lng: -83.9966 },
  { name: 'Zoo Atlanta',                                           lat: 33.7337, lng: -84.3715 },
  { name: 'Atlanta Botanical Garden',                              lat: 33.7904, lng: -84.3729 },
  { name: 'Chattahoochee River National Recreation Area',          lat: 33.9477, lng: -84.4247 },
  { name: 'Silver Comet Trail — Trailhead Mavell Road',            lat: 33.8648, lng: -84.5625 },
]
  ...
  const { data, error } = await db
    ...
    .insert({
      ...
      metadata: {
        ...
        distance,
        duration,
        script:        'create-atlanta-stone-mountain',
