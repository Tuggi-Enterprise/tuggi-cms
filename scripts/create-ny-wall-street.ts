/**
 * create-ny-wall-street.ts
 *
 * Cria a rota "Wall Street, o Touro e o 11 de Setembro — Financial District de NY"
 * no banco de dados.
 *
 * O script:
 *   1. Define 12 landmarks do Financial District de Nova York
 ...
 *
 * Uso:
 *   npx tsx scripts/create-ny-wall-street.ts
 *   npx tsx scripts/create-ny-wall-street.ts --force   # recria se já existir
 */
...
const ROUTE_NAME        = 'Wall Street, o Touro e o 11 de Setembro — Financial District de NY'
const ROUTE_DESCRIPTION = 'O roteiro pelo coração financeiro do mundo: da Bolsa de Nova York ao Touro de Wall Street; do memorial do 11 de setembro à One World Trade Center com seu deck de observação; da Federal Reserve Bank (onde fica o maior depósito de ouro do mundo, 6.000 toneladas!) à St. Paul\'s Chapel que sobreviveu milagrosamente ao ataque. Termine na ponta de Manhattan com a vista gratuita da Ilha da Estátua da Liberdade no Staten Island Ferry Terminal. Um roteiro de caminhada pelo bairro mais poderoso e histórico de Nova York — onde o dinheiro e a história se encontram.'
...
const ROUTE_LANDMARKS: RouteLandmark[] = [
  { name: 'Charging Bull (Touro de Wall Street)',                 lat: 40.7056, lng: -74.0134 },
  { name: 'New York Stock Exchange — A Bolsa de Valores de NY',  lat: 40.7069, lng: -74.0113 },
  { name: 'Federal Hall — Onde Washington foi Inaugurado Presidente', lat: 40.7069, lng: -74.0089 },
  { name: 'Federal Reserve Bank of NY — 6.000 Ton de Ouro Embaixo', lat: 40.7081, lng: -74.0092 },
  { name: 'Oculus / Fulton Center — A Borboleta Branca de Calatrava', lat: 40.7115, lng: -74.0120 },
  { name: '9/11 Memorial — As Piscinas no Local das Torres',     lat: 40.7115, lng: -74.0134 },
  { name: 'One World Trade Center — Freedom Tower (541m)',       lat: 40.7127, lng: -74.0133 },
  { name: 'St. Paul\'s Chapel — Sobreviveu ao 11 de Setembro',  lat: 40.7112, lng: -74.0083 },
  { name: 'Seaport District — O Velho Porto de NY',              lat: 40.7056, lng: -74.0036 },
  { name: 'Brooklyn Bridge — Atravessar a Pé (lado Manhattan)',  lat: 40.7061, lng: -73.9969 },
  { name: 'Battery Park — Vista Gratuita da Estátua da Liberdade', lat: 40.7033, lng: -74.0170 },
  { name: 'Staten Island Ferry Terminal — Travessia Gratuita',   lat: 40.6996, lng: -74.0134 },
]
