/**
 * create-rio-maravilhas.ts
 *
 * Cria a rota "Rio de Janeiro — As Maravilhas Cariocas em Um Dia" no banco de dados.
 *
 * O script:
 *   1. Define 14 landmarks dos principais pontos turísticos do Rio de Janeiro
 ...
 *
 * Uso:
 *   npx tsx scripts/create-rio-maravilhas.ts
 *   npx tsx scripts/create-rio-maravilhas.ts --force   # recria se já existir
 */
...
const ROUTE_NAME        = 'Rio de Janeiro — As Maravilhas Cariocas em Um Dia'
const ROUTE_DESCRIPTION = 'A jornada completa pelas maravilhas do Rio de Janeiro: suba ao Cristo Redentor com vista de 360° da cidade, contemple a Baía de Guanabara do alto do Pão de Açúcar, caminhe na Copacabana e Ipanema, explore o Jardim Botânico e a Lagoa Rodrigo de Freitas, mergulhe na modernidade do Museu do Amanhã no Porto Maravilha e encerre no bairro histórico de Santa Teresa. Um roteiro de carro que revela por que o Rio é considerada uma das cidades mais bonitas do mundo — onde natureza, cultura e praias se encontram a cada esquina.'
...
const ROUTE_LANDMARKS: RouteLandmark[] = [
  { name: 'Cristo Redentor — Corcovado',                          lat: -22.9519, lng: -43.2104 },
  { name: 'Mirante Dona Marta — Vista do Rio',                    lat: -22.9463, lng: -43.1996 },
  { name: 'Pão de Açúcar',                                        lat: -22.9491, lng: -43.1573 },
  { name: 'Urca — O Vilarejo Tranquilo do Rio',                   lat: -22.9540, lng: -43.1645 },
  { name: 'Praia de Copacabana',                                  lat: -22.9694, lng: -43.1883 },
  { name: 'Praia de Ipanema',                                     lat: -22.9850, lng: -43.1965 },
  { name: 'Lagoa Rodrigo de Freitas',                             lat: -22.9716, lng: -43.2205 },
  { name: 'Jardim Botânico do Rio de Janeiro',                    lat: -22.9670, lng: -43.2224 },
  { name: 'Vista Chinesa — Parque Nacional da Tijuca',            lat: -22.9640, lng: -43.2670 },
  { name: 'Maracanã',                                             lat: -22.9121, lng: -43.2302 },
  { name: 'Santa Teresa — O Bairro Boêmio nas Alturas',          lat: -22.9228, lng: -43.1856 },
  { name: 'Lapa — Arcos e Vida Noturna',                         lat: -22.9117, lng: -43.1810 },
  { name: 'Museu do Amanhã — Porto Maravilha',                   lat: -22.8942, lng: -43.1799 },
  { name: 'Praça XV e Centro Histórico',                         lat: -22.9021, lng: -43.1747 },
]
...
async function insertRoute(
  ...
  const { data, error } = await db
    ...
    .insert({
      ...
      drivability:       'easy',
      scenic_profile:    ['panoramic', 'historical', 'urban', 'nature'],
