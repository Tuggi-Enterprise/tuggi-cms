/**
 * create-rio-bohemio.ts
 *
 * Cria a rota "Rio Boêmio — Samba, Lapa, Santa Teresa e a Alma Carioca" no banco de dados.
 *
 * O script:
 *   1. Define 12 landmarks dos bairros boêmios e culturais do Rio
 ...
 *
 * Uso:
 *   npx tsx scripts/create-rio-bohemio.ts
 *   npx tsx scripts/create-rio-bohemio.ts --force   # recria se já existir
 */
...
const ROUTE_NAME        = 'Rio Boêmio — Samba, Lapa, Santa Teresa e a Alma Carioca'
const ROUTE_DESCRIPTION = 'Mergulhe na alma mais autêntica do Rio de Janeiro: o roteiro boêmio que conecta os bairros onde o Rio pulsa de verdade. Comece no vilarejo tranquilo de Urca, suba a Santa Teresa — o bairro dos artistas e boêmios, com bares charmosos e vistas incríveis. Desça para a Lapa dos Arcos, berço do samba e da vida noturna carioca. Caminhe até a Pedra do Sal onde o samba nasceu no século XIX, chegue ao moderno Porto Maravilha e termine na Praça Mauá. Um roteiro 100% seguro para turistas que querem conhecer o Rio que não aparece nos cartões-postais — mas que é igualmente deslumbrante.'
...
const ROUTE_LANDMARKS: RouteLandmark[] = [
  { name: 'Urca — Vilarejo Calmo com Vista do Pão de Açúcar',    lat: -22.9540, lng: -43.1645 },
  { name: 'Cobal do Humaitá — Mercado Gastronômico de Botafogo', lat: -22.9575, lng: -43.1879 },
  { name: 'Aterro do Flamengo',                                   lat: -22.9303, lng: -43.1702 },
  { name: 'Catete — Palácio da República e Rua Boêmia',         lat: -22.9273, lng: -43.1780 },
  { name: 'Santa Teresa — Escadaria Selarón',                    lat: -22.9177, lng: -43.1831 },
  { name: 'Santa Teresa — Bar do Mineiro e Largo das Neves',     lat: -22.9278, lng: -43.1886 },
  { name: 'Lapa — Arcos da Lapa (Aqueduto Carioca)',             lat: -22.9117, lng: -43.1810 },
  { name: 'Circo Voador — Lapa',                                 lat: -22.9133, lng: -43.1804 },
  { name: 'Pedra do Sal — Berço do Samba Carioca',              lat: -22.9050, lng: -43.1851 },
  { name: 'Museu do Amanhã',                                     lat: -22.8942, lng: -43.1799 },
  { name: 'Praça Mauá — AquaRio e Porto Maravilha',             lat: -22.8956, lng: -43.1794 },
  { name: 'Feira de São Cristóvão (Centro Luiz Gonzaga)',       lat: -22.9012, lng: -43.2146 },
]
...
async function insertRoute(
  ...
  const { data, error } = await db
    ...
    .insert({
      ...
      best_time:         ['afternoon', 'sunset', 'night'],
