 ...
 * create-ny-cinema.ts
 *
 * Cria a rota "Nova York no Cinema — Locações Icônicas do Maior Estúdio a Céu Aberto do Mundo"
 * no banco de dados.
 *
 * O script:
 *   1. Define 11 landmarks de locações reais de filmes famosos em Nova York
 ...
 *
 * Uso:
 *   npx tsx scripts/create-ny-cinema.ts
 *   npx tsx scripts/create-ny-cinema.ts --force   # recria se já existir
 */
