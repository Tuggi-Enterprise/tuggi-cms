/**
 * create-sp-criancas.ts
 *
 * Cria a rota "São Paulo para Crianças — Parques, Zoológico, Ciência e Diversão" no banco de dados.
 *
 * O script:
 *   1. Define 12 landmarks (sequência geográfica otimizada) para famílias com crianças
 ...
 *
 * Uso:
 *   npx tsx scripts/create-sp-criancas.ts
 *   npx tsx scripts/create-sp-criancas.ts --force   # recria se já existir
 */
...
const ROUTE_NAME        = 'São Paulo para Crianças — Parques, Zoológico, Ciência e Diversão'
const ROUTE_DESCRIPTION = 'O roteiro mais completo de São Paulo para famílias com crianças: começa com ciência no Catavento e polvos no Aquário de São Paulo, visita o maior zoológico da América do Sul e o lindo Jardim Botânico ao lado, descobre a história do Brasil no Museu do Ipiranga, brinca nos parques mais amados da cidade — Ibirapuera, Aclimação e Vila Lobos — e termina na floresta do Horto Florestal. Um dia inteiro de carro cheio de descobertas, natureza e muita alegria para toda a família, sem sair de São Paulo.'
...
// ─── Landmarks — rota completa (sequência geográfica otimizada) ──────────────

const ROUTE_LANDMARKS: RouteLandmark[] = [
  // Manhã: ciência e animais (região leste/centro)
  { name: 'Museu Catavento — Ciência para Toda a Família',       lat: -23.5497, lng: -46.6324 },
  { name: 'Aquário de São Paulo (Expo Center Norte)',            lat: -23.5185, lng: -46.6093 },
  { name: 'Jardim Zoológico de São Paulo',                       lat: -23.6491, lng: -46.6183 },
  { name: 'Jardim Botânico de São Paulo',                        lat: -23.6476, lng: -46.6213 },
  { name: 'Parque da Independência — Museu do Ipiranga',        lat: -23.5843, lng: -46.6098 },
  // Tarde: parques e cultura (região sul/centro)
  { name: 'Parque da Aclimação',                                 lat: -23.5645, lng: -46.6348 },
  { name: 'Parque Ibirapuera',                                   lat: -23.5855, lng: -46.6577 },
  { name: 'Museu de Arte Moderna (MAC Ibirapuera)',              lat: -23.5876, lng: -46.6568 },
  { name: 'Museu do Futebol — Estádio do Pacaembu',             lat: -23.5459, lng: -46.6654 },
  // Final de tarde: parques na zona oeste
  { name: 'Parque Vila Lobos',                                   lat: -23.5453, lng: -46.7231 },
  // Zona norte: natureza exuberante
  { name: 'Horto Florestal',                                     lat: -23.4731, lng: -46.6297 },
  { name: 'Parque Estadual da Cantareira — Trilhas na Mata Atlântica', lat: -23.3816, lng: -46.6253 },
]
