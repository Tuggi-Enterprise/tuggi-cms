/**
 * create-sp-vida-noturna.ts
 *
 * Cria a rota "São Paulo à Noite — Bares, Cultura e a Vida Noturna Paulistana" no banco de dados.
 *
 * O script:
 *   1. Define 12 landmarks pelos bairros mais animados de São Paulo à noite
 ...
 *
 * Uso:
 *   npx tsx scripts/create-sp-vida-noturna.ts
 *   npx tsx scripts/create-sp-vida-noturna.ts --force   # recria se já existir
 */
...
const ROUTE_NAME        = 'São Paulo à Noite — Bares, Cultura e a Vida Noturna Paulistana'
const ROUTE_DESCRIPTION = 'São Paulo tem a vida noturna mais vibrante da América Latina — e este roteiro mostra o melhor dela. Dos lounges sofisticados do Itaim Bibi e Jardins às bodegas e botecos do Pinheiros, dos bares de vinho da Rua Mourato Coelho às chopeiras artesanais de Vila Madalena, do Beco do Batman com arte de rua à Praça Benedito Calixto com brechós e música ao vivo. Um roteiro seguro, variado e inesquecível pelos bairros mais animados de São Paulo — que podem começar ao entardecer e ir madrugada adentro sem nunca deixar de surpreender.'
const ROUTE_COUNTRY     = 'Brazil'
const ROUTE_REGION      = 'São Paulo'
...
// ─── Landmarks — rota completa (início de noite até madrugada) ───────────────

const ROUTE_LANDMARKS: RouteLandmark[] = [
  // Início: sofisticado (início de noite)
  { name: 'Itaim Bibi — Bares e Restaurantes Gourmet',           lat: -23.5842, lng: -46.6778 },
  { name: 'Jardins — Rua Oscar Freire e Aperitivos',             lat: -23.5652, lng: -46.6638 },
  // Centro cultural / noturno
  { name: 'Rua Augusta — Bares e Cultura LGBTQ+',               lat: -23.5564, lng: -46.6568 },
  { name: 'Praça Roosevelt — Teatros e Botecos',                 lat: -23.5487, lng: -46.6519 },
  // Vila Madalena / Pinheiros
  { name: 'Beco do Batman — Arte de Rua e Vila Madalena',        lat: -23.5535, lng: -46.6966 },
  { name: 'Rua Mourato Coelho — Bares e Restaurantes',          lat: -23.5556, lng: -46.6892 },
  { name: 'Praça Benedito Calixto — Brechós e Música ao Vivo',  lat: -23.5596, lng: -46.6974 },
  { name: 'Rua Fradique Coutinho — Gastropubs de Pinheiros',    lat: -23.5575, lng: -46.6966 },
  { name: 'Largo da Batata — Eventos e Comida de Rua',          lat: -23.5630, lng: -46.6978 },
  { name: 'SESC Pinheiros — Cultura e Shows',                    lat: -23.5654, lng: -46.6981 },
  // Final de noite: Vila Olímpia / Brooklin
  { name: 'Vila Olímpia — Clubes e Baladas',                     lat: -23.5957, lng: -46.6841 },
  { name: 'Brooklin — Bares Descontraídos e Zona Comercial',    lat: -23.6163, lng: -46.7001 },
]
