/**
 * create-acores-ponta-delgada.ts
 *
 * Cria a rota "Ponta Delgada — Charme Barroco, Museus e a Capital Açoriana" no banco de dados.
 *
 * O script:
 *   1. Define 8 landmarks do centro histórico de Ponta Delgada
 ...
 *
 * DEMO especial Bensaude Hotels — rota parte do Grand Hotel Açores Atlântico Bensaude (Ponta Delgada)
 *
 * Uso:
 *   npx tsx scripts/create-acores-ponta-delgada.ts
 *   npx tsx scripts/create-acores-ponta-delgada.ts --force   # recria se já existir
 */
...
const ROUTE_NAME        = 'Ponta Delgada a Pé — Centro Histórico em 2 Horas'
const ROUTE_DESCRIPTION = 'A rota de caminhada perfeita pelo coração histórico de Ponta Delgada — tudo a menos de 2km, sem carro. Parte do Grand Hotel Bensaude e percorre o centro histórico: as icónicas Portas da Cidade barrocas, a Igreja São Sebastião com azulejos únicos do século XVI, o Convento de Nossa Senhora da Esperança com o veneradíssimo Santo Cristo dos Milagres, o Mercado da Graça com ananás dos Açores e queijo da ilha, e o passeio marítimo com a vista para o Forte de São Brás. Uma manhã de descoberta cultural que qualquer hóspede consegue fazer sozinho — 2 horas, bom calçado, câmara fotográfica.'
...
// ─── Landmarks — passeio a pé pelo centro histórico (~2km total) ──────────────
// Todos os pontos estão dentro do núcleo urbano histórico.
// Sequência: hotel → Portas → Igreja → Convento → Mercado → Marina → Forte

const ROUTE_LANDMARKS: RouteLandmark[] = [
  { name: 'Grand Hotel Açores Atlântico Bensaude — Ponto de Partida',         lat: 37.7412, lng: -25.6703 },
  { name: 'Portas da Cidade — Portal Barroco de 3 Arcos (Símbolo da Cidade)', lat: 37.7388, lng: -25.6720 },
  { name: 'Câmara Municipal — Largo da Câmara e Praça Central',               lat: 37.7390, lng: -25.6700 },
  { name: 'Igreja Matriz São Sebastião — Azulejos do Séc. XVI e Torre dos Sinos', lat: 37.7385, lng: -25.6705 },
  { name: 'Convento N.ª Sr.ª da Esperança — Santo Cristo dos Milagres',        lat: 37.7410, lng: -25.6618 },
  { name: 'Mercado da Graça — Ananás, Queijo e Alcatra dos Açores',           lat: 37.7378, lng: -25.6640 },
  { name: 'Passeio Marítimo — Frente de Mar de Ponta Delgada',                lat: 37.7345, lng: -25.6680 },
  { name: 'Forte de São Brás — Fortaleza do Séc. XVI (vista para o Atlântico)', lat: 37.7358, lng: -25.6582 },
]
  ...
  const { data, error } = await db
    ...
    .insert({
      ...
      metadata: {
        ...
        distance,
        duration,
        script:        'create-acores-ponta-delgada-walk',
      ...
      drivability:       'unknown',  // rota a pé — abrir Google Maps modo pedestre
      scenic_profile:    ['historical', 'urban'],
