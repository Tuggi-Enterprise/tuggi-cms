/**
 * create-sp-paulista.ts
 *
 * Cria a rota "Avenida Paulista e Arredores — O Coração Cultural de São Paulo" no banco de dados.
 *
 * O script:
 *   1. Define 14 landmarks dos principais pontos turísticos da Paulista e arredores
 ...
 *
 * Uso:
 *   npx tsx scripts/create-sp-paulista.ts
 *   npx tsx scripts/create-sp-paulista.ts --force   # recria se já existir
 */
...
const ROUTE_NAME        = 'Avenida Paulista e Arredores — O Coração Cultural de São Paulo'
const ROUTE_DESCRIPTION = 'O roteiro definitivo pelo coração de São Paulo: a Avenida Paulista e tudo que pulsa ao seu redor. Do MASP com sua arquitetura suspensa ao Mercadão com os melhores pastéis do mundo; de Liberdade, o maior bairro japonês fora do Japão, à Pinacoteca com arte brasileira; do Parque Ibirapuera com seus museus e lagoa ao Museu do Ipiranga recém-renovado. Um dia de carro que revela os múltiplos personagens de São Paulo — cidade cosmopolita, cultural e vibrante que não para nunca.'
...
const ROUTE_LANDMARKS: RouteLandmark[] = [
  { name: 'MASP — Museu de Arte de São Paulo',                    lat: -23.5614, lng: -46.6562 },
  { name: 'Parque Trianon',                                       lat: -23.5641, lng: -46.6569 },
  { name: 'Instituto Cultural Itaú',                              lat: -23.5571, lng: -46.6550 },
  { name: 'Rua Augusta — Cultura e Estilo',                       lat: -23.5564, lng: -46.6568 },
  { name: 'Rua Oscar Freire — Luxo e Gastronomia',               lat: -23.5652, lng: -46.6638 },
  { name: 'Praça da República',                                   lat: -23.5431, lng: -46.6411 },
  { name: 'Mercadão — Mercado Municipal de São Paulo',           lat: -23.5426, lng: -46.6281 },
  { name: 'Liberdade — O Bairro Japonês',                        lat: -23.5589, lng: -46.6349 },
  { name: 'Pinacoteca do Estado e Parque da Luz',                lat: -23.5347, lng: -46.6340 },
  { name: 'Museu da Língua Portuguesa — Estação da Luz',        lat: -23.5338, lng: -46.6334 },
  { name: 'Parque Ibirapuera',                                   lat: -23.5855, lng: -46.6577 },
  { name: 'Museu do Ipiranga — Parque da Independência',        lat: -23.5843, lng: -46.6098 },
  { name: 'SESC Paulista',                                       lat: -23.5700, lng: -46.6540 },
  { name: 'Consolação — Praça Roosevelt e Cultura',             lat: -23.5487, lng: -46.6519 },
]
