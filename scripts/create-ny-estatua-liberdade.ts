/**
 * create-ny-estatua-liberdade.ts
 *
 * Cria a rota "Estátua da Liberdade, Ellis Island e o Outro Lado do Rio — Rota de Ferry"
 * no banco de dados.
 *
 * O script:
 *   1. Define 9 landmarks da rota de ferry até a Estátua da Liberdade e Nova Jersey
 ...
 *      NOTA: Rota de FERRY e CAMINHADA — OSRM usa roteamento de carro como aproximação.
 *      Para trechos de ferry (Liberty Island, Ellis Island), OSRM faz fallback para linha reta
 *      — correto, pois mostra o caminho na água.
 ...
 *
 * Uso:
 *   npx tsx scripts/create-ny-estatua-liberdade.ts
 *   npx tsx scripts/create-ny-estatua-liberdade.ts --force   # recria se já existir
 */
...
const ROUTE_NAME        = 'Estátua da Liberdade, Ellis Island e o Outro Lado do Rio — Rota de Ferry'
const ROUTE_DESCRIPTION = 'A experiência mais americana que existe: de ferry até a Estátua da Liberdade e Ellis Island (onde 12 milhões de imigrantes, incluindo muitos brasileiros, chegaram na América), depois cruzar para Nova Jersey e ver Manhattan pela perspectiva mais bonita possível — do outro lado do rio Hudson. Hoboken com seu waterfront charmoso, Jersey City com a Liberty State Park e os piers com o skyline de Manhattan como pano de fundo. Uma viagem de um dia que vai mostrar NY de um ângulo que poucos turistas conhecem. Rota 100% de ferry e caminhada.'
...
const ROUTE_LANDMARKS: RouteLandmark[] = [
  { name: 'Battery Park / Castle Clinton — Embarque para a Estátua', lat: 40.7033, lng: -74.0170 },
  { name: 'Liberty Island — Estátua da Liberdade',               lat: 40.6892, lng: -74.0445 },
  { name: 'Ellis Island — O Portal da América para 12 Milhões de Imigrantes', lat: 40.6995, lng: -74.0397 },
  { name: 'Liberty State Park — Jersey City, NJ',                lat: 40.7081, lng: -74.0629 },
  { name: 'Jersey City Waterfront Exchange Place',               lat: 40.7160, lng: -74.0348 },
  { name: 'Newport Waterfront — Jersey City (vistas de Manhattan)', lat: 40.7272, lng: -74.0432 },
  { name: 'Hoboken Waterfront Park — O Melhor Panorama de Manhattan', lat: 40.7358, lng: -74.0249 },
  { name: 'Hoboken Terminal — PATH de volta a Manhattan',        lat: 40.7358, lng: -74.0311 },
  { name: 'Pier A Harbor House — Battery Park, Manhattan',       lat: 40.7008, lng: -74.0149 },
]
  ...
  const { data, error } = await db
    ...
    .insert({
      ...
      metadata: {
        ...
        distance,
        duration,
        script:        'create-ny-estatua-liberdade',
      ...
      drivability:       'unknown',
      scenic_profile:    ['panoramic', 'historical', 'nature'],
