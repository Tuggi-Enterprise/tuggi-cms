/**
 * create-ny-midtown-icons.ts
 *
 * Cria a rota "Midtown Manhattan — Os Ícones de Nova York Num Só Dia" no banco de dados.
 *
 * O script:
 *   1. Define 12 landmarks dos ícones do Midtown Manhattan
 ...
 *
 * Uso:
 *   npx tsx scripts/create-ny-midtown-icons.ts
 *   npx tsx scripts/create-ny-midtown-icons.ts --force   # recria se já existir
 */
...
const ROUTE_NAME        = 'Midtown Manhattan — Os Ícones de Nova York Num Só Dia'
const ROUTE_DESCRIPTION = 'O roteiro Hop-On Hop-Off definitivo de Manhattan a pé: os ícones do Midtown que aparecem em todo guia de viagem de Nova York. Do Empire State Building ao Chrysler Building; do Grand Central Terminal com seu teto estrelado ao Bryant Park e sua patinação no inverno; do Rockefeller Center com o Top of the Rock ao Carnegie Hall; do MoMA com as obras de Van Gogh à Times Square com suas telas gigantes. Um dia de caminhada por 12 dos pontos mais icônicos de NY — no coração do bairro que inspirou o mundo.'
...
const ROUTE_LANDMARKS: RouteLandmark[] = [
  { name: 'Times Square — O Centro do Mundo',                    lat: 40.7580, lng: -73.9855 },
  { name: 'Empire State Building — 102 Andares de História',    lat: 40.7484, lng: -73.9857 },
  { name: 'Bryant Park + NY Public Library — "Ghostbusters" e "Day After Tomorrow"', lat: 40.7536, lng: -73.9832 },
  { name: 'Grand Central Terminal — O Teto Estrelado Mais Famoso do Mundo', lat: 40.7527, lng: -73.9772 },
  { name: 'Chrysler Building — O Art Deco Mais Lindo de NY',    lat: 40.7516, lng: -73.9755 },
  { name: 'United Nations Headquarters',                         lat: 40.7489, lng: -73.9680 },
  { name: 'Rockefeller Center — Top of the Rock + NBC Tour',    lat: 40.7587, lng: -73.9787 },
  { name: 'Radio City Music Hall',                               lat: 40.7599, lng: -73.9800 },
  { name: 'MoMA — Museum of Modern Art',                         lat: 40.7614, lng: -73.9776 },
  { name: 'Carnegie Hall',                                       lat: 40.7651, lng: -73.9800 },
  { name: 'Columbus Circle — Entrada do Central Park',          lat: 40.7681, lng: -73.9819 },
  { name: 'Hudson Yards — Edge Observation Deck e The Vessel',  lat: 40.7537, lng: -74.0013 },
]
  ...
  const { data, error } = await db
    ...
    .insert({
      ...
      metadata: {
        ...
        distance,
        duration,
        script:        'create-ny-midtown-icons',
