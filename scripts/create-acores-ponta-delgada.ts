...
const ROUTE_NAME        = 'Ponta Delgada — Charme Barroco, Museus e a Capital Açoriana'
const ROUTE_DESCRIPTION = 'Para os hóspedes do Grand Hotel Açores Atlântico Bensaude que querem explorar Ponta Delgada a pé: a capital açoriana guarda séculos de história num raio de caminhada. As Portas da Cidade barrocas do século XVIII que simbolizam a cidade, a Igreja de São Sebastião com os seus azulejos únicos, o Forte de São Brás que defendeu a ilha dos piratas, a gruta de lava de 2.000 anos do Carvão, os Jardins Botânicos de José do Canto do século XIX e o animado Mercado da Graça onde os açorianos compram ananás, alcatra e queijo da ilha. Uma manhã ou tarde perfeita partindo directamente do hotel a pé ou de carro.'
...
// ─── Landmarks da rota Ponta Delgada ─────────────────────────────────────────

const ROUTE_LANDMARKS: RouteLandmark[] = [
  { name: 'Grand Hotel Açores Atlântico Bensaude — Centro de Ponta Delgada',  lat: 37.7412, lng: -25.6703 },
  { name: 'Portas da Cidade — Portal Barroco do Século XVIII (símbolo da cidade)', lat: 37.7388, lng: -25.6720 },
  { name: 'Igreja Matriz São Sebastião — Gótico Manuelino com Azulejos Únicos', lat: 37.7385, lng: -25.6705 },
  { name: 'Forte de São Brás — Fortaleza do Século XVI Contra a Pirataria',  lat: 37.7380, lng: -25.6600 },
  { name: 'Mercado da Graça — Ananás dos Açores, Queijo da Ilha, Alcatra',   lat: 37.7380, lng: -25.6640 },
  { name: 'Museu Carlos Machado — Arte e História Natural dos Açores',        lat: 37.7400, lng: -25.6720 },
  { name: 'Mata-Jardim José do Canto — Jardim Botânico do Século XIX',       lat: 37.7440, lng: -25.6600 },
  { name: 'Gruta do Carvão — Túnel de Lava de 2.000 Anos (Visita Guiada)',   lat: 37.7470, lng: -25.6500 },
]
  ...
  const { data, error } = await db
    ...
    .insert({
      ...
      metadata: {
        ...
        distance,
        duration,
        script:        'create-acores-ponta-delgada',
