/**
 * create-atlanta-kennesaw-marietta.ts
 *
 * Cria a rota "Kennesaw & Marietta — A Guerra Civil, o Trem Roubado e o Sul Histórico" no banco de dados.
 *
 * O script:
 *   1. Define 12 landmarks de Marietta, Kennesaw Mountain e arredores históricos
 ...
 *      (POIs de Atlanta/North Georgia NÃO estão no banco Tuggi — todos serão genéricos)
 ...
 *
 * Uso:
 *   npx tsx scripts/create-atlanta-kennesaw-marietta.ts
 *   npx tsx scripts/create-atlanta-kennesaw-marietta.ts --force   # recria se já existir
 */
...
const ROUTE_NAME        = 'Kennesaw & Marietta — A Guerra Civil, o Trem Roubado e o Sul Histórico'
const ROUTE_DESCRIPTION = 'Uma viagem ao coração do Sul histórico americano a partir de Atlanta: percorra Marietta com sua praça encantadora e museu do "Gone with the Wind", suba o Kennesaw Mountain onde aconteceu uma das batalhas mais importantes da Guerra Civil, e descubra o extraordinário museu da Great Locomotive Chase — o roubo de trem mais ousado da história americana, que inspirou filmes e virou lenda. Uma rota que combina história profunda, natureza exuberante e o charme autêntico das pequenas cidades do Sul dos EUA, tudo a menos de 30 minutos de Atlanta.'
const ROUTE_COUNTRY     = 'United States'
const ROUTE_REGION      = 'North Georgia'
...
// ─── Landmarks — rota completa (dia inteiro de carro) ────────────────────────

const ROUTE_LANDMARKS: RouteLandmark[] = [
  // ── Atlanta: ponto de partida ──
  { name: 'Downtown Atlanta — Ponto de Partida',                   lat: 33.7490, lng: -84.3880 },
  // ── Marietta ──
  { name: 'Marietta Square — Coração Histórico da Cidade',         lat: 33.9520, lng: -84.5498 },
  { name: 'Gone with the Wind Museum (Marietta)',                   lat: 33.9511, lng: -84.5485 },
  { name: 'Marietta Museum of History',                            lat: 33.9514, lng: -84.5490 },
  { name: 'Marietta National Cemetery',                            lat: 33.9517, lng: -84.5543 },
  // ── Kennesaw Mountain National Battlefield Park ──
  { name: 'Kennesaw Mountain NB — Visitor Center',                 lat: 33.9893, lng: -84.5789 },
  { name: 'Kennesaw Mountain Summit — Vista Panorâmica de Atlanta',lat: 33.9935, lng: -84.5828 },
  { name: 'Pigeon Hill — Trincheiras da Guerra Civil',             lat: 33.9952, lng: -84.5882 },
  { name: 'Cheatham Hill — Memorial dos Soldados Illinoisan',      lat: 33.9686, lng: -84.5854 },
  // ── Downtown Kennesaw ──
  { name: 'Southern Museum — Great Locomotive Chase (Big Shanty)', lat: 34.0196, lng: -84.5993 },
  { name: 'Kennesaw Downtown & Railroad Museum',                   lat: 34.0234, lng: -84.6153 },
  // ── Fim: Red Top Mountain ou Allatoona Lake ──
  { name: 'Red Top Mountain State Park — Lago Allatoona',          lat: 34.1478, lng: -84.7128 },
]
  ...
  const { data, error } = await db
    ...
    .insert({
      ...
      metadata: {
        ...
        distance,
        duration,
        script:        'create-atlanta-kennesaw-marietta',
      ...
      drivability:       'easy',
      scenic_profile:    ['historical', 'nature', 'panoramic'],
