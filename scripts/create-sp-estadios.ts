/**
 * create-sp-estadios.ts
 *
 * Cria a rota "São Paulo Esportiva — Estádios, Autódromo e Templos do Esporte Paulistano" no banco de dados.
 *
 * O script:
 *   1. Define 10 landmarks (loop geográfico lógico) dos grandes estádios e arenas de SP
 ...
 *
 * Uso:
 *   npx tsx scripts/create-sp-estadios.ts
 *   npx tsx scripts/create-sp-estadios.ts --force   # recria se já existir
 */
...
const ROUTE_NAME        = 'São Paulo Esportiva — Estádios, Autódromo e Templos do Esporte Paulistano'
const ROUTE_DESCRIPTION = 'São Paulo concentra mais estádios e arenas esportivas de alto nível do que qualquer outra cidade da América do Sul. Este roteiro de carro percorre os grandes templos do esporte paulistano: o imponente Allianz Parque do Palmeiras; o Morumbi do São Paulo FC; o histórico Pacaembu (hoje Pacaembu Sociedade do Futebol); o Canindé da Portuguesa; o Ginásio do Ibirapuera onde a Seleção Brasileira de Vôlei faz história; o mítico Autódromo José Carlos Pace em Interlagos, palco do GP do Brasil de Fórmula 1; e a futurística Neo Química Arena do Corinthians em Itaquera. Um tour completo pelos palcos onde o esporte brasileiro vira paixão nacional.'
...
// ─── Landmarks — loop geográfico lógico por SP ───────────────────────────────

const ROUTE_LANDMARKS: RouteLandmark[] = [
  // Zona Oeste / Centro
  { name: 'Allianz Parque — Palmeiras (Palestra Itália)',         lat: -23.5271, lng: -46.7179 },
  { name: 'Estádio do Pacaembu — História do Futebol Paulistano', lat: -23.5459, lng: -46.6654 },
  { name: 'Canindé — Portuguesa de Desportos',                   lat: -23.5049, lng: -46.6204 },
  // Zona Sul / Centro-Sul
  { name: 'Ginásio do Ibirapuera — Seleção de Vôlei e Basquete',lat: -23.5882, lng: -46.6605 },
  { name: 'Estádio do Morumbi — São Paulo FC',                   lat: -23.6005, lng: -46.7197 },
  // Zona Sul extremo
  { name: 'Autódromo José Carlos Pace — GP do Brasil de F1',     lat: -23.7014, lng: -46.6991 },
  // Zona Sul / Abc
  { name: 'Estádio Nicolau Alayon — EC Santo André',             lat: -23.6512, lng: -46.5318 },
  // Zona Leste
  { name: 'Neo Química Arena — Corinthians (Itaquerão)',         lat: -23.5453, lng: -46.4741 },
  // Volta pelo Norte
  { name: 'Arena Barueri — Multiuso e Seleção Brasileira',       lat: -23.4966, lng: -46.8740 },
  { name: 'Centro de Treinamento Paralímpico (legado Pan 2007)', lat: -23.7158, lng: -46.5413 },
]
