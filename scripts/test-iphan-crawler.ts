...
// Test POIs that might have IPHAN heritage information
...
async function testIPHANCrawler() {
  console.log('🏛️  Testing IPHAN Crawler...\n');
  ...
  console.log('\n🏛️  IPHAN Crawler test completed!');
}

// Run the test
testIPHANCrawler().catch(console.error);
