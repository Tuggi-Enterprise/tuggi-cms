/**
 * create-acores-sete-cidades.ts
 *
 * Cria a rota "Sete Cidades e a Costa Oeste — As 7 Maravilhas de Portugal nos Açores" no banco de dados.
 *
 * O script:
 *   1. Define 8 landmarks da rota Sete Cidades / Costa Oeste
 ...
 *
 * Uso:
 *   npx tsx scripts/create-acores-sete-cidades.ts
 *   npx tsx scripts/create-acores-sete-cidades.ts --force   # recria se já existir
 */
...
const ROUTE_NAME        = 'Sete Cidades e a Costa Oeste — As 7 Maravilhas de Portugal nos Açores'
const ROUTE_DESCRIPTION = 'Sete Cidades é eleita uma das 7 Maravilhas Naturais de Portugal e o cartão-postal mais icônico dos Açores: duas lagoas — uma azul, uma verde — separadas por uma ponte dentro de uma cratera vulcânica. Esta rota parte do Grand Hotel Açores Atlântico Bensaude em Ponta Delgada e percorre o anel Oeste da ilha: a Lagoa do Fogo no centro, a Costa Norte com a Caldeira Velha, as piscinas vulcânicas de Mosteiros encravadas na lava atlântica, e a subida à Vista do Rei com o panorama mais fotografado dos Açores. Uma rota de dia completo que mostra por que São Miguel é chamada "A Ilha Verde".'
...
// ─── Landmarks da rota Sete Cidades ──────────────────────────────────────────

const ROUTE_LANDMARKS: RouteLandmark[] = [
  { name: 'Grand Hotel Açores Atlântico Bensaude — Partida (Ponta Delgada)', lat: 37.7412, lng: -25.6703 },
  { name: 'Miradouro da Lagoa do Fogo — Lago de Cratera no Coração da Ilha', lat: 37.7500, lng: -25.4667 },
  { name: 'Caldeira Velha — Cascata Mineral e Piscinas Termais na Mata',     lat: 37.8130, lng: -25.4200 },
  { name: 'Ribeira Grande — Segunda Cidade da Ilha (Costa Norte)',            lat: 37.8360, lng: -25.5190 },
  { name: 'Plantação de Chá Gorreana — A Única Plantação de Chá da Europa',  lat: 37.8278, lng: -25.5380 },
  { name: 'Piscinas Naturais de Mosteiros — Lava Atlântica Esculpida pelo Mar', lat: 37.8980, lng: -25.8232 },
  { name: 'Vista do Rei — O Miradouro das Sete Cidades (UNESCO)',             lat: 37.8392, lng: -25.7949 },
  { name: 'Lagoa das Sete Cidades — Na Beira do Lago dentro da Cratera',     lat: 37.8697, lng: -25.7800 },
]
  ...
  const { data, error } = await db
    ...
    .insert({
      ...
      metadata: {
        ...
        distance,
        duration,
        script:        'create-acores-sete-cidades',
