/**
 * create-rio-praias.ts
 *
 * Cria a rota "Rota das Praias Cariocas — De Botafogo a Grumari" no banco de dados.
 *
 * O script:
 *   1. Define 13 landmarks da orla carioca de ponta a ponta
 ...
 *
 * Uso:
 *   npx tsx scripts/create-rio-praias.ts
 *   npx tsx scripts/create-rio-praias.ts --force   # recria se já existir
 */
...
const ROUTE_NAME        = 'Rota das Praias Cariocas — De Botafogo a Grumari'
const ROUTE_DESCRIPTION = 'O roteiro mais épico de praias do Rio de Janeiro: um passeio de carro pela orla carioca de ponta a ponta, da Enseada de Botafogo com a icônica vista do Pão de Açúcar até a paradisíaca Grumari, a praia mais intocada e preservada da cidade. No caminho: Copacabana, Arpoador (o melhor pôr do sol do Rio), Ipanema, Leblon, Vidigal, São Conrado, Barra da Tijuca, Recreio e Prainha. Cada praia com seu próprio clima, cada uma mais linda que a anterior. Um dia inteiro que mostra por que o Rio tem a orla mais famosa do mundo.'
...
const ROUTE_LANDMARKS: RouteLandmark[] = [
  { name: 'Enseada de Botafogo — Vista Clássica do Pão de Açúcar', lat: -22.9541, lng: -43.1789 },
  { name: 'Praia Vermelha — Urca',                                lat: -22.9549, lng: -43.1680 },
  { name: 'Praia de Copacabana',                                  lat: -22.9694, lng: -43.1883 },
  { name: 'Pedra do Arpoador — Melhor Pôr do Sol do Rio',        lat: -22.9884, lng: -43.2005 },
  { name: 'Praia de Ipanema',                                     lat: -22.9850, lng: -43.1965 },
  { name: 'Praia do Leblon',                                      lat: -22.9857, lng: -43.2290 },
  { name: 'Praia do Vidigal',                                     lat: -22.9927, lng: -43.2523 },
  { name: 'Praia de São Conrado / Pepino (Voo Livre)',           lat: -22.9982, lng: -43.2888 },
  { name: 'Praia da Barra da Tijuca',                            lat: -23.0074, lng: -43.3450 },
  { name: 'Praia do Recreio dos Bandeirantes',                   lat: -23.0156, lng: -43.4640 },
  { name: 'Praia de Prainha',                                    lat: -23.0375, lng: -43.5010 },
  { name: 'Praia de Grumari — Fim da Linha, Começo do Paraíso', lat: -23.0397, lng: -43.5284 },
  { name: 'Trilha do Grumari — Mirante da Pedra Bonita',        lat: -22.9980, lng: -43.3010 },
]
