/**
 * create-atlanta-classic.ts
 *
 * Cria a rota "Atlanta Clássica — Olimpíadas, Coca-Cola e a Alma da Cidade" no banco de dados.
 *
 * O script:
 *   1. Define 14 landmarks dos principais pontos turísticos de Atlanta
 ...
 *
 * Uso:
 *   npx tsx scripts/create-atlanta-classic.ts
 *   npx tsx scripts/create-atlanta-classic.ts --force   # recria se já existir
 */
...
const ROUTE_NAME        = 'Atlanta Clássica — Olimpíadas, Coca-Cola e a Alma da Cidade'
const ROUTE_DESCRIPTION = 'O roteiro turístico definitivo de Atlanta: do legado dos Jogos Olímpicos de 1996 ao sabor mais famoso do mundo, passando pela roda-gigante SkyView, o aquário de água doce mais visitado do mundo, o CNN Center e os bairros mais vibrantes da cidade. Uma jornada de carro pelo coração histórico e cultural de Atlanta, a cidade que renasceu das cinzas para se tornar a capital do Sul dos Estados Unidos.'
...
const ROUTE_LANDMARKS: RouteLandmark[] = [
  { name: 'Centennial Olympic Park — Legado dos Jogos de 1996',    lat: 33.7609, lng: -84.3929 },
  { name: 'World of Coca-Cola',                                     lat: 33.7624, lng: -84.3930 },
  { name: 'Georgia Aquarium — Um dos Maiores do Mundo',            lat: 33.7633, lng: -84.3949 },
  { name: 'National Center for Civil and Human Rights',            lat: 33.7622, lng: -84.3985 },
  { name: 'SkyView Atlanta — A Grande Roda (The Eye)',             lat: 33.7586, lng: -84.3911 },
  { name: 'CNN Center & Omni Hotel',                               lat: 33.7575, lng: -84.3960 },
  { name: 'Mercedes-Benz Stadium',                                 lat: 33.7553, lng: -84.4008 },
  { name: 'Martin Luther King Jr. National Historic Site',         lat: 33.7509, lng: -84.3711 },
  { name: 'Sweet Auburn Historic District',                        lat: 33.7523, lng: -84.3772 },
  { name: 'Ponce City Market',                                     lat: 33.7700, lng: -84.3631 },
  { name: 'Atlanta BeltLine — Eastside Trail',                     lat: 33.7677, lng: -84.3584 },
  { name: 'Piedmont Park',                                         lat: 33.7839, lng: -84.3733 },
  { name: 'Fox Theatre — O Mais Belo Teatro do Sul',               lat: 33.7730, lng: -84.3873 },
  { name: 'Buckhead — Nightlife & Luxury District',                lat: 33.8459, lng: -84.3616 },
]
