/**
 * create-ny-central-park.ts
 *
 * Cria a rota "Central Park — Do Jardim do Sul à Floresta do Norte" no banco de dados.
 *
 * O script:
 *   1. Define 12 landmarks do Central Park de Nova York (sul ao norte)
 ...
 *      NOTA: Rota de CAMINHADA (ou bicicleta) — OSRM usa roteamento de carro como
 *      aproximação das vias internas do parque.
 ...
 *
 * Uso:
 *   npx tsx scripts/create-ny-central-park.ts
 *   npx tsx scripts/create-ny-central-park.ts --force   # recria se já existir
 */
...
const ROUTE_NAME        = 'Central Park — Do Jardim do Sul à Floresta do Norte'
const ROUTE_DESCRIPTION = '843 acres no coração de Manhattan: o Central Park é um dos parques urbanos mais famosos do mundo e um roteiro por si só. Esta rota vai do sul ao norte descobrindo os tesouros escondidos e os monumentos icônicos: o Carrossel, a famosa Bethesda Fountain e Terrace, a Bow Bridge (a ponte mais fotografada de NY), Strawberry Fields (memorial de John Lennon), o castelo medieval de Belvedere, o Reservatório Jacqueline Kennedy Onassis e a floresta do norte com o charming Harlem Meer. Um passeio de caminhada ou bicicleta inesquecível pelos jardins que separam o Upper West do Upper East Side.'
...
const ROUTE_LANDMARKS: RouteLandmark[] = [
  { name: 'Grand Army Plaza — Entrada Sul do Central Park (59th & 5th)', lat: 40.7645, lng: -73.9726 },
  { name: 'The Pond — O Primeiro Lago ao Entrar no Parque',      lat: 40.7663, lng: -73.9740 },
  { name: 'Dairy & Chess House — Carrossel e Área das Crianças', lat: 40.7675, lng: -73.9768 },
  { name: 'Sheep Meadow — Grande Gramado Central',               lat: 40.7731, lng: -73.9767 },
  { name: 'Bethesda Fountain & Terrace — O Coração do Parque',  lat: 40.7731, lng: -73.9703 },
  { name: 'Bow Bridge — A Ponte Mais Fotografada de New York',   lat: 40.7748, lng: -73.9765 },
  { name: 'Strawberry Fields — Memorial de John Lennon',         lat: 40.7760, lng: -73.9765 },
  { name: 'Belvedere Castle — Vista Panorâmica do Parque',       lat: 40.7789, lng: -73.9697 },
  { name: 'Great Lawn — Onde Acontecem os Grandes Concertos',    lat: 40.7813, lng: -73.9682 },
  { name: 'Jacqueline Kennedy Onassis Reservoir',                lat: 40.7849, lng: -73.9626 },
  { name: 'Metropolitan Museum of Art (5th Ave)',                lat: 40.7794, lng: -73.9632 },
  { name: 'Harlem Meer — A Lagoa do Norte e The Conservatory',  lat: 40.7974, lng: -73.9524 },
]
...
async function insertRoute(
  ...
  const { data, error } = await db
    ...
    .insert({
      ...
      drivability:       'unknown',
      scenic_profile:    ['nature', 'panoramic', 'urban'],
