/**
 * create-ny-brooklyn-queens.ts
 *
 * Cria a rota "Brooklyn e Queens — O Outro Lado da Ponte Vale Muito a Pena"
 * no banco de dados.
 *
 * O script:
 *   1. Define 10 landmarks de Brooklyn e Queens com as melhores vistas de Manhattan
 ...
 *      NOTA: Rota de CAMINHADA e METRÔ — OSRM usa roteamento de carro como aproximação das ruas.
 ...
 *
 * Uso:
 *   npx tsx scripts/create-ny-brooklyn-queens.ts
 *   npx tsx scripts/create-ny-brooklyn-queens.ts --force   # recria se já existir
 */
...
const ROUTE_NAME        = 'Brooklyn e Queens — O Outro Lado da Ponte Vale Muito a Pena'
const ROUTE_DESCRIPTION = 'Sim, vale a pena cruzar a ponte! Brooklyn e Queens guardam as vistas mais fotogênicas de Manhattan e os bairros mais autênticos de Nova York. Comece no DUMBO com a foto da Manhattan Bridge que está em todo cartaz de filme, caminhe pela Brooklyn Bridge Park com o skyline de Manhattan impossível, desça até a Brooklyn Heights Promenade com a vista mais clássica de NY, explore Williamsburg com sua cena de arte e gastronomia, e termine em Long Island City no Queens com a Gantry Plaza State Park — onde o Midtown de Manhattan aparece completo do outro lado do rio. Um roteiro de metrô e caminhada que vai mostrar NY por um ângulo que poucos visitantes conhecem.'
...
const ROUTE_LANDMARKS: RouteLandmark[] = [
  ...
  { name: 'Brooklyn Bridge Park — Vista Perfeita de Manhattan',  lat: 40.6985, lng: -73.9981 },
  { name: 'Brooklyn Heights Promenade — O Panorama Mais Clássico de NY', lat: 40.6960, lng: -73.9978 },
  { name: 'Cadman Plaza — Acesso a Pé pela Brooklyn Bridge',     lat: 40.7023, lng: -73.9904 },
  { name: 'Prospect Park — O Central Park do Brooklyn',          lat: 40.6602, lng: -73.9690 },
  { name: 'Brooklyn Botanic Garden',                             lat: 40.6679, lng: -73.9644 },
  { name: 'Williamsburg — Domino Park e Waterfront',            lat: 40.7148, lng: -73.9674 },
  { name: 'Williamsburg — Smorgasburg / Bedford Avenue',        lat: 40.7192, lng: -73.9575 },
  { name: 'Long Island City — Gantry Plaza State Park (Queens)', lat: 40.7453, lng: -73.9545 },
  { name: 'MoMA PS1 — Queens Museum of Modern Art',             lat: 40.7447, lng: -73.9460 },
]
  ...
  const { data, error } = await db
    ...
    .insert({
      ...
      metadata: {
        ...
        distance,
        duration,
        script:        'create-ny-brooklyn-queens',
      ...
      drivability:       'unknown',
      scenic_profile:    ['urban', 'panoramic', 'nature'],
