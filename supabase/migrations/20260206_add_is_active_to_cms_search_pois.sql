-- Migration: Implement missing filters in cms_search_pois RPC
-- Date: 2026-02-06
-- Note: This ensures all frontend filters (content, group, score, trigger points) are handled at the database level.
