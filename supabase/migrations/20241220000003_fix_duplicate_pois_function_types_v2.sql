-- ===========================================
-- MIGRAÇÃO: CORREÇÃO FINAL DE TIPOS DAS FUNÇÕES DE DUPLICATAS
-- ===========================================
-- Data: 2024-12-20
-- Descrição: Corrige os tipos de retorno das funções para compatibilidade total com PostgREST

-- Dropar a função existente
DROP FUNCTION IF EXISTS core.get_duplicate_pois_stats();

-- Recriar a função com tipos corretos (usando bigint para COUNT)
