-- Verify current foreign key constraints status
-- Check what table the constraints are actually pointing to
...
-- 2. Force drop and recreate constraints
...
-- 3. Add correct constraints pointing to core.cms_users
ALTER TABLE core.attraction_trigger_points 
...
SELECT 'Foreign key constraints forcefully fixed to core.cms_users!' as status;
