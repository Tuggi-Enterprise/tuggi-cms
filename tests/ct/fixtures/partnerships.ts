...
export function queueRow(overrides: Partial<ClientDirectoryRow> = {}): ClientDirectoryRow {
  return {
    ...
    target: { kind: 'proposal', submissionId: 'sub-0001' },
    name: 'Cantina do Zé',
    country: null,
    clientType: 'venue',
    status: 'pending',
...
export const QUEUE_ROWS_IN_PROGRESS: ClientDirectoryRow[] = [
  ...
  queueRow({
    ...
    target: { kind: 'client', clientId: 'client-0005', tab: 'partnership' },
...
export const BOARD_ROWS_EVERY_COLUMN: ClientDirectoryRow[] = QUEUE_ROWS_IN_PROGRESS.concat([
  ...
  queueRow({
    ...
    contract: 'signed',
    status: 'approved',
    target: { kind: 'client', clientId: 'client-0007', tab: 'partnership' },
    name: 'Café da Praça',
  ...
  queueRow({
    ...
    contract: 'signed',
    status: 'approved',
    target: { kind: 'client', clientId: 'client-0009', tab: 'partnership' },
    name: 'Bar do Mirante',
