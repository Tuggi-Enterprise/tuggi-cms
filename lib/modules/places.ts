/**
 * Módulo Locais/Comércios — gate (espelha lib/modules/marketing.ts, mas real).
 *
...
export function isPlacesEnabled(e?: Entitlements): boolean {
  return isModuleEnabled(MODULES.PLACES, e)
}
