...
export class TriggerPointsService {
  ...
  // REMOVED: Main generateTriggerPoints method - not used by current system
  // The system uses direct implementation in detect/route.ts instead

  // REMOVED: generateStreetBasedTriggerPoints method - not used by current system
  // The system uses direct implementation in detect/route.ts instead
  ...
  // REMOVED: generateBoundaryBasedTriggerPoints method - not used by current system  
  // The system uses direct implementation in detect/route.ts instead
